...
class ScannedItem extends StatefulWidget {
  @override
  _ScannedItemState createState() => _ScannedItemState();
}
...
class _ScannedItemState extends State<ScannedItem> {
  ...
  Widget build(BuildContext context) {
    ...
    {
      return MainModel.CurrentItem==null?
...
//    color: Colors.blue,
    ...
    child: Column(
      ...
      children: <Widget>[
      Text("Price  : ${MainModel.CurrentItem.price.toString()}₹",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold), ),
      Text("\nMRP           : ${MainModel.CurrentItem.price.toString()}₹",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.grey), ),
      Text("\nWeight\n${MainModel.CurrentItem.weight.toString()} gm",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black54), ),
      Text("\nBarcode\n${MainModel.CurrentItem.barcode.toString()}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.black54), ),
      ],
    ),
  );
}
...
Widget TotalPrice(context,MainModel MainModel){
  ...
  return Container(
    ...
    width: MediaQuery.of(context).size.width/2,
//    color: Colors.blue,
    child: Text("Total : ${total().toString()} ₹",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.black),),
  );
}