...
class OpenItemSuggestion extends StatefulWidget {
  @override
  _OpenItemSuggestionState createState() => _OpenItemSuggestionState();
}

class _OpenItemSuggestionState extends State<OpenItemSuggestion> {
  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: ScopedModelDescendant<MainModel>(
          ...
          {
            return
//              MainModel.CurrentItemSuggestion==null?
                  ...
                  child: Stack(
                    ...
                    children: <Widget>[
                      Align(
                        ...
                        child: Text(MainModel.CurrentItemSuggestion.name.toString(),
//                      child: Text('eg',
                        ...
                        child: Material(
                          ...
                          child: SizedBox(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(10),
                              child: Image.network(
                                MainModel.CurrentItemSuggestion.pic_url.toString(),
...
//    color: Colors.blue,
    ...
    child: Column(
      ...
      children: <Widget>[
        Text("Price  : ${MainModel.CurrentItemSuggestion.price.toString()}₹",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold), ),
        Text("\nMRP           : ${MainModel.CurrentItemSuggestion.price.toString()}₹",style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold,color: Colors.grey), ),
        Text("\nWeight\n${MainModel.CurrentItemSuggestion.weight.toString()} gm",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.black54), ),
        Text("\nBarcode\n${MainModel.CurrentItemSuggestion.barcode.toString()}",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.black54), ),
      ],
    ),
  );
}
...
//                      side: BorderSide(color: Colors.black12,style: BorderStyle.solid,width: 2)
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(MainModel.CurrentItemSuggestion.quantity.toString(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
          Material(
            elevation: 5,
            shape: CircleBorder(),
            child: Container(
      ...
      child: Center(
        child: RaisedButton(
            ...
            onPressed: () {
              ...
              MainModel.Add_item_to_cart(MainModel.CurrentItemSuggestion,MainModel.Main_Details.email,MainModel.Main_Details.orderID);
...
Widget TotalPrice(context,MainModel MainModel){
  ...
  total(){
    double price = double.parse(MainModel.CurrentItemSuggestion.price.toString());
    double quantity = double.parse(MainModel.CurrentItemSuggestion.quantity.toString());
